    ...
    <div className="pt-20 flex flex-col">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent text-5xl md:text-8xl mb-4">
              Find your Dream Car with FloxWrap AI
            </h1>
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Discover the best car deals tailored to your needs with the power of AI.
            </p>
          </div>
