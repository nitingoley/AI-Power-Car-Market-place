...
import { addCar, processCarImageWiththeAI } from "@/actions/cars";
...
const AddCarForm = () => {
  ...
  const {
  ...
  } = useFetch(processCarImageWiththeAI);
   ...
   useEffect(()=>{
    if(processImageError) {
      toast.error(processImageError.message || "Failed to upload cars");
    }
   },[processImageError]);
   ...
   useEffect(()=>{
    if(processImageResult?.success){
      ...
      toast.success("Successfully extracted car details" , {
       ...
       // switch to manual tab for the user to review the details 
       setActiveTab("manual");
    }
